...
public abstract class Validator {
    ...
    public void remove(View view, String errorMessage) {
...
//        Log.i(TAG, "Adding: " + validationHolder.getTextInputLayout().getHint());
    ...
    public ArrayList<ValidationHolder> getmValidationHolderList() {
        return mValidationHolderList;
    }
