...
public class AwesomeValidation {
    ...
    public void remove(View view) {
        mValidator.remove(view);
    }

    public void remove(View view, String errMsg) {
        mValidator.remove(view, errMsg);
    }

    public List<ValidationHolder> current() {
        return mValidator.getmValidationHolderList();
    }
